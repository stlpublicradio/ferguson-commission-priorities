...
ferguson-commission-priorities
========================
...
**TKTK: Describe ferguson-commission-priorities here.**
...
```
cd ferguson-commission-priorities
mkvirtualenv ferguson-commission-priorities
...
```
workon ferguson-commission-priorities
fab render
```
...
```
* * * * * ubuntu bash /home/ubuntu/apps/ferguson_commission_priorities/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|ferguson-commission-priorities|tweet|`location`||
|ferguson-commission-priorities|facebook|`location`||
|ferguson-commission-priorities|email|`location`||
|ferguson-commission-priorities|new-comment||
|ferguson-commission-priorities|open-share-discuss||
|ferguson-commission-priorities|close-share-discuss||
|ferguson-commission-priorities|summary-copied||
|ferguson-commission-priorities|featured-tweet-action|`action`|
|ferguson-commission-priorities|featured-facebook-action|`action`|
