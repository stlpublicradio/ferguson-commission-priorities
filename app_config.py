...
PROJECT_SLUG = 'ferguson-commission-priorities'

# Project name to be used in file paths
PROJECT_FILENAME = 'ferguson_commission_priorities'

# The name of the repository containing the source
REPOSITORY_NAME = 'ferguson-commission-priorities'
...
ASSETS_SLUG = 'ferguson-commission-priorities'
